...
public class PortafolioFragment extends Fragment {
    ...
    public PortafolioFragment(String idPropio) {
        this.idPropio=idPropio;
    }

    public static PortafolioFragment newInstance(String param1, String param2) {
        PortafolioFragment fragment = new PortafolioFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_portafolio, container, false);
        recview=(RecyclerView)view.findViewById(R.id.recview);
        recview.setLayoutManager(new LinearLayoutManager(getContext()));

        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(DbRef.child(id), model.class)
                        .build();
